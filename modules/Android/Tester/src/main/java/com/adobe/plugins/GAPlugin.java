    ...
    public boolean execute(String action, JSONArray args, CallbackContext callback) {
        ...
        if (action.equals("initGA")) {
            ...
            try {
                ...
                callback.success("trackEvent - category = " + args.getString(0) + "; action = " + args.getString(1)
                        + "; label = " + args.getString(2) + "; value = " + args.getInt(3));
                return true;
            } catch (final Exception e) {
                callback.error(e.getMessage());
            }
            ...
            try {
                ...
                callback.success("setVariable passed - index = " + args.getInt(2) + "; key = " + args.getString(0)
