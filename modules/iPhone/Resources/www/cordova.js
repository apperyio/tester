...
function onScriptLoadingComplete(moduleList) {
    ...
    console.log("====Start importing plugins===");
...
// Exadel
// Remove all paramters (query) string from path
function removeParametersPath(path) {
    var result = path;

    var paramPos = result.indexOf('?');
    if (paramPos != -1) {
...
function findCordovaPath() {
    ...
    for (var n = scripts.length-1; n>-1; n--) {
        // Exadel fix
        var src = removeParametersPath(scripts[n].src);
